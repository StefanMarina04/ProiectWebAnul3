    ...
    return (
        <>
            ...
            <Container fluid className="pt-0 mt-0 pe-3 d-flex justify-content-end align-items-end" style={{ position: 'relative', zIndex: 999 }}>
                <Button
                    className={`${styles.vintageAudioButton} ${isPlayingMusic ? styles.playingMusic : styles.pausedMusic} me-2`}
                    variant="link"
                    onClick={toggleMusic}
                    aria-label={isPlayingMusic ? t('Pause Music') : t('Play Music')}
                    data-tooltip={isPlayingMusic ? t('Pause Music') : t('Play Music')}
                >
                </Button>
            ...
            <div className={styles.mainSection}>
                ...
                <audio ref={audioRef} src="/audio/Vrei sa ne intalnim sâmbata seara.mp3" loop />
            ...
            <Container className="mt-4 mb-4">
                ...
                <Row>
                    ...
                    <Col lg={4} className={`d-flex flex-column text-lg-center text-center pe-lg-3 mb-4 ${styles.rowDivider}`}>
                        ...
                        <div className={`text-center mb-2 ${styles.ThreeColumnSubtext}`}>
                            {t('See maps, transport routes and more!')}
                        </div>
                        <div className="mt-auto d-flex flex-column align-items-center pt-3">
                            <Link
                                href="/extra"
